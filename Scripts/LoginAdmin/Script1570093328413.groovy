...
//WebUI.verifyElementChecked(findTestObject('LoginPage/Page_Laravel/label_Remember Me'), 1)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/DashboardPage/Page_Laravel/button_Banned IPs_sidebarToggle'), 
    0)
